...
- 数字盛り (= 売上 / 期間 / 効果の誇張)
- ElevenLabs 等の新コスト発生 provider (= jun 確認)
- 自分達で使ってない商品の「販売開始 / publish」 articulate (= 5/17 軸)
- 候補列挙「A/B/C/D どれにする?」 form (= 5/18 z-r-5 軸、 zen_stop_hook で警告)
- 「直ちに動かす?」 着手前に articulate (= 5/18 z-r-8 軸、 zen_stop_hook で警告)
- 表を比較以外で使う (= 5/18 z-r-6 軸、 zen_stop_hook で警告)
