...
公開済み 9 本（2026-04-19 時点、Zenn 側で確認）:
...
9. 販売中のMCPテンプレに19件の脆弱性を見つけた話 — Codexクロスレビュー7巡の記録（2026-04-18 執筆、2026-04-18 夜 Zenn 同期成立）

> 記事は Zenn に一次掲載しており、このリポジトリにミラーは置かない（drift 防止）。
>
> **訂正履歴 (2026-04-19)**: 4/18 時点で「8 本公開 + 1 本は同期待ち」と記述していたが、4/18 夜の空 commit `0546fa7` で Zenn 同期が成立、4/19 朝の WebFetch 200 確認で公開確定。現在 9 本全て公開済み。
