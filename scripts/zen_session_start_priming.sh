...
echo "  例 1: 「やったこと: CLAUDE.md のリンク切れを 8 件直しました。 結果: 全部既存ファイルに繋がりました。 これからどうするか: README の更新に移ります。」"
echo "  例 2: 「Zen のメモリーで、 もう存在しないファイルを 10 件指していました。 直しました。」"
echo "  例 3: 「『narrative』『form』『drift』 は使いません。 『言い方』『形』『ズレ』 と書きます。」"
echo ""
